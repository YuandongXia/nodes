          ...
          (______/|_____)_|_|_| \__)_____)\____)_| |_|
           ...
           ______    _                _                     
          |  ____|  (_)              | |                    
          | |__ _ __ _  ___ _ __   __| | ___ ___  _ __ ___  
          |  __| '__| |/ _ \ '_ \ / _` |/ __/ _ \| '_ ` _ \ 
          | |  | |  | |  __/ | | | (_| | (_| (_) | | | | | |
          |_|  |_|  |_|\___|_| |_|\__,_|\___\___/|_| |_| |_|
               (C)2017 Friendcom

LoRaWAN endpoint stack implementation and AT Commands projects.
=====================================
...
4. Dependencies
----------------
This program depends on specific hardware platforms. Currently the used
platform are:
    - SensorNode
        MCU     : STM32L072CB - Ultra-low-power 32-bit MCU Arm-based Cortex-M0+, 
                                up to 192KB Flash, 20KB SRAM, 6KB EEPROM, USB, ADC, DACs
...
2017-10-26, V1.0.0
* General
    1. Based on the SensorNode project to create a new project, remove the unnecessary application code, and port it to the STM32L072CB hardware platform.
